 ...
 */
template <typename T> class TProbSpV {
    private:
        /// The map containing non-default elements
        std::vector<SpElem<T> > _p;
    ...
    //@}
        ...
        typedef typename std::vector<SpElem<T> >::const_iterator const_iterator;
        /// Iterator over the elements
        typedef typename std::vector<SpElem<T> >::iterator iterator;
        /// Constant reverse iterator over the elements
        typedef typename std::vector<SpElem<T> >::const_reverse_iterator const_reverse_iterator;
        /// Reverse iterator over the elements
        typedef typename std::vector<SpElem<T> >::reverse_iterator reverse_iterator;
