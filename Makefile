...
HEADERS=$(foreach name,graph dag bipgraph spvector spvector_map index var factor factorsp varset smallset fo prob probsp daialg properties alldai enum exceptions util,$(INC)/$(name).h)
